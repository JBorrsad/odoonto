...
export function Appointment({ id, patientName, startTime, endTime, treatment, status, color }: AppointmentProps) {
    ...
    <div className={cn("p-2 rounded-lg h-full border flex flex-col", getBackgroundColor(), getBorderColor())}>
      <div className="flex justify-between items-start mb-1">
        <div className="flex items-center gap-1.5">
          <div
            className={cn(
              "w-5 h-5 rounded-sm flex items-center justify-center text-white text-xs font-medium",
              getLetterColor(),
            )}
          >
            {getLetter()}
