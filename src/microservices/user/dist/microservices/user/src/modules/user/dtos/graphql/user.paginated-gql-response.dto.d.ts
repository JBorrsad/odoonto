...
declare const UserPaginatedGraphqlResponseDto_base: import('@nestjs/common').Type<
  IPaginatedType<UserGraphqlResponseDto>
>;
export declare class UserPaginatedGraphqlResponseDto
  extends UserPaginatedGraphqlResponseDto_base
